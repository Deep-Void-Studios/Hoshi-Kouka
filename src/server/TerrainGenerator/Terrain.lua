...
local stretch = script:GetAttribute("stretch")
local planetScale = script:GetAttribute("planetScale")
local seed = script:GetAttribute("seed")
local yield = script:GetAttribute("yield")
local decoFrequency = script:GetAttribute("decorationFrequency")

local plantWeight = script:GetAttribute("weightPlant")
local rockWeight = script:GetAttribute("weightRock")
local weightSum = plantWeight + rockWeight

local scale = chunkMod:GetAttribute("scale")
local yScale = chunkMod:GetAttribute("yScale")
local rDist = chunkMod:GetAttribute("rDist")
